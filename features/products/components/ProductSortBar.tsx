  ...
  return (
    <div className="flex flex-col gap-4 border-b border-gray-100 pb-4 md:flex-row md:items-center md:justify-between lg:mb-6 lg:pb-6">
      <div className="flex flex-wrap items-center gap-4 text-xl md:gap-6">
        ...
        <button className="font-bold text-[#0b5cce] underline underline-offset-4">
          Liên quan
        </button>
        ...
        <select className="ml-2 h-9 rounded-md border border-gray-200 bg-white px-3 text-sm text-gray-700 outline-none hover:border-gray-300 focus:border-[#0b5cce]">
      ...
      <div className="flex items-center gap-3 text-sm text-gray-600">
        ...
        <div className="flex items-center gap-1">
          ...
          <button className="flex h-8 w-8 items-center justify-center rounded-md border border-gray-200 bg-white text-gray-600 hover:border-[#0b5cce] hover:text-[#0b5cce]">
